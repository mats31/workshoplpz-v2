...
import MobileText from './meshes/MobileText';
...
class ProjectContainer extends THREE.Object3D {
  ...
  constructor(options) {
    ...
    this._scaleFactor = 1;
    this._spring = 0.02;
    this._friction = 0.77 + Math.random() * 0.05;
  ...
  _setupPreview() {
    this._previewTexture = States.resources.getTexture('daphne-preview').media;
